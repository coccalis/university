...
public class Deposit extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<div class=\"div-middle\">" +
                "        <h1>Deposit Money</h1>" +
                "        <form action='deposit2' method='post'>" +
                "            <input class=\"inputs\" type=\"text\"  name=\"AccountID\"  readonly value='" + account.getId() + "' required/><br>" +
                "            <input class=\"inputs\" type=\"text\"  name=\"Deposit\" placeholder=\"Amount\" required/><br>"  +
                "            <input type=\"submit\" value=\"Deposit\" class=\"button\" style= \"margin-top: 30px;\" ></input>" +
                "        </form>" +
                "    </div>");
